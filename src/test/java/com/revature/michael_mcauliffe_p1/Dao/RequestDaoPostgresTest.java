...
public class RequestDaoPostgresTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		request1 = new Request(200.00, "Test description.", EventType.SEMINAR, "Texas", 6,
				start1, end1, posting, GradeFormat.PASS_FAIL, null, null, false);
		...
		request2 = new Request(100, "Other description.", EventType.TECHNICAL_TRAINING, "New York",
				3, start2, end2, posting, GradeFormat.PASS_FAIL, null, null, false);
	...
	public void insertGradeTest() {
		...
		assertTrue("Should return true if file upload was successful.", requestDao.insertGrade(request1.getFormID(), grade));
	}
