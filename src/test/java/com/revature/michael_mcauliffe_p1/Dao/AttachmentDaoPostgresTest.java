...
public class AttachmentDaoPostgresTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		try {
			...
			fis = new FileInputStream("C:\\Java Programs\\com.revature.michael_mcauliffe_p1\\src\\test\\resources\\Test File 2.txt");
	...
	public void deleteExistingAttachmentTest() {
		...
		assertTrue("Should return true if entry was deleted.", attachmentDao.deleteAttachment(attachment1.getAttachmentID()));
	}
